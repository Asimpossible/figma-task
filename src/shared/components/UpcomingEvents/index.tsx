...
const Index: React.FC = () => {
    ...
    return (
        <>
            <div className='my-[120px] mx-[100px] h-[453px] flex flex-col gap-5'>
                <div className="title  text-textBlack font-poppins font-semibold text-[28px] flex justify-between">
                ...
                <div className="events w-full h-[391px]">
                    <Slider {...settings} className='w-full h-full !p-0 !m-0 !box-border'>
                        <div className='!w-[295px] h-[362.77px]'>
                            <div className="image w-full !h-[220px] relative bg-[url('/images/outdoor.svg')]"></div>
                        ...
                        <div className='!w-[295px] h-[362.77px]'>
                            <div className="image w-full !h-[220px] relative bg-[url('/images/tech.svg')]"></div>
                            <div className="content px-2 flex flex-col gap-1 w-full h-[140px]">
                        ...
                        <div className='!w-[295px] h-[382.77px]'>
                            <div className="image w-full !h-[220px] relative bg-[url('/images/photograph.svg')]"></div>
                            <div className="content px-2 flex flex-col gap-1 w-full h-[140px]">
                        ...
                        <div className='!w-[295px] h-[362.77px]'>
                            <div className="image w-full !h-[220px] relative bg-[url('/images/jazz.svg')]"></div>
                            <div className="content px-2 flex flex-col gap-1 w-full h-[140px]">
